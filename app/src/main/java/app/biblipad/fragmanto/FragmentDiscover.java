...
public class FragmentDiscover extends RootFragment {
    ...
    private void setupTabIcons() {
        ...
        tabOne3.setText("Popular");
        tabLayout.getTabAt(2).setCustomView(ll3);
    }

    private void setupViewPager(CustomViewPager viewPager) {
        adapter = new ViewPagerAdapter(getFragmentManager());
        adapter.addFragment(new FragmenttRecent(), "Recent");
        adapter.addFragment(new FragmenttRecommended(), "Recommended");
        adapter.addFragment(new FragmenttPopular(), "Popular");
